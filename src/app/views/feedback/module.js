(function ()
{
    ...
    angular.module('view.feedback', ['view.app'])
        ...
        .controller('feedbackController', function ($scope, $rootScope, $timeout, $http, _apiUrlBase)
        {
            var timeout = 5000;
            ...
            $scope.sendFeedback = function ()
            {
                $scope.complete = true;
                $http
                    .post(_apiUrlBase + 'v1/contact/feedback', {
                        version  : $rootScope._version,
                        feedback : $scope.feedback.comment
                    })
                    .then(function (data)
                    {
