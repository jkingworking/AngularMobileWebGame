(function ()
{
    ...
    angular.module('view.games', [])
        ...
        .controller('gamesController', function ($scope, $rootScope, $state, ModalService, localStorageService, $http, _apiUrlBase)
        {
            ...
            function loadData()
            {
                return $http.get(_apiUrlBase + 'v2/games/available').then(
                    function (data)
                    {
