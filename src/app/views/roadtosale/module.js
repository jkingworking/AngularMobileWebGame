...
angular.module('view.roadToSale', [])
    ...
    .controller('roadToSaleController', function ($scope, $rootScope, $state, ModalService, localStorageService, $http)
    {
        $scope.games = [];
        ...
        function loadData(){
            $http.get($rootScope._apiUrlBase + 'v2/games/road_to_sale').then(
                function (data)
                {
