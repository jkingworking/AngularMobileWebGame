(function ()
{
    ...
    angular.module('mbsApp', modules)
        ...
        .constant('_apiUrlBase', (function ()
        {
            return (window.location.hostname.substring(0, 6) === 'local.') ? 'http://local.api.salesdawg.com/' : 'http://api.salesdawg.com/';
        })())
        .constant('_dev', (function ()
        {
            return (window.location.hostname.substring(0, 6) === 'local.');
        })())
