...
angular.module('directive.games.questionAnswer', [])
    ...
    .controller('gameQuestionAnswerController', function ($scope, $rootScope, $http, ModalService)
    {
        ...
        $scope.submitAnswer = function ()
        {
            ...
            $http.post($rootScope._apiUrlBase + 'v1/game/play/' + $scope.gameData.id, postData);
